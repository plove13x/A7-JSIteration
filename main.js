//1.    (Another student told me Mason meant to write $23.63...)
...
items.filter(function(item) {
  return item.materials.length >= 8;
    ...
    item2.materials.forEach(function(a) {
      console.log(a);
    });
});
...
var numHomeMade = items.filter(function(item) {
  return item.who_made === "i_did";
});
console.log(numHomeMade.length + " were made by their sellers");
